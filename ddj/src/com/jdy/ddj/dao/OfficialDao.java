...
public interface OfficialDao {
	 ...
	 *
     */
    void updateByWhere(@Param("requestBean") RequestBean requestBean, @Param("record") Official official);
	 ...
	 * 根据条件查询
     */
    List<Official> getByWhere(@Param("requestBean") RequestBean requestBean);

    /**
     * @param requestBean 
	 * 分页查询
     */
    List<Official> findPage(@Param("requestBean") RequestBean requestBean);
