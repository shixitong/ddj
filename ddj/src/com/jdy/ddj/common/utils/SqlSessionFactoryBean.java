...
public class SqlSessionFactoryBean implements FactoryBean<SqlSessionFactory>, InitializingBean, ApplicationListener<ApplicationEvent> {
    ...
    protected SqlSessionFactory buildSqlSessionFactory() throws IOException {
        ...
        if (!isEmpty(this.typeAliasesLocations)) {
            for (Resource cfgLocation : this.typeAliasesLocations) {
                if (cfgLocation == null) {
                    continue;
                }
                XPathParser parser = getXPathParser(cfgLocation.getInputStream());
                parseTypeAliasesElement(parser,configuration);
            }
        } else {
            if (this.logger.isDebugEnabled()) {
                this.logger.debug("Property 'typeAliasesLocations' was not specified or no matching resources found");
            }
        }
     ...
     * @return
     */
    private XPathParser getXPathParser(InputStream inputStream) {
        return new XPathParser(inputStream, true, null, new XMLMapperEntityResolver());
    }
